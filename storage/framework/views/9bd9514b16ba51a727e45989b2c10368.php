...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.inviteMember'); ?> <?php echo e($companyName); ?></h5>
            ...
            <nav class="tabs border-bottom-grey">
                <div class="nav" id="myTabs" role="tablist">
                    <a class="nav-item nav-link f-15 active" href="#inviteEmail" data-toggle="tab" id="inviteEmail-tab"
                       ...
                       aria-selected="true"><?php echo app('translator')->get('modules.employees.inviteEmail'); ?>
                    </a>
                    ...
                    <a class="nav-item nav-link f-15" href="#inviteLink" role="tab" data-toggle="tab"
                       id="inviteLink-tab" aria-controls="inviteLink" aria-selected="false">
                        <?php echo app('translator')->get('modules.employees.inviteLink'); ?>
                    </a>
                </div>
            </nav>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'secondary','icon' => 'info-circle']); ?><?php echo app('translator')->get('messages.inviteInfo'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'inviteEmailForm']); ?>
                        <div class="row">
                            <div class="col-sm-12">
                                <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'invitee_email','fieldLabel' => __('app.email'),'fieldName' => 'email','fieldRequired' => true,'fieldPlaceholder' => __('placeholders.email')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldId' => 'message','fieldLabel' => __('modules.messages.message'),'fieldName' => 'message','fieldPlaceholder' => __('modules.employees.message')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\ButtonPrimary::resolve(['icon' => 'paper-plane'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'send-invite']); ?>
                                    <?php echo app('translator')->get('modules.employees.sendInvite'); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'inviteLinkForm']); ?>
                        <div class="row py-3">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'createLinkLabel','fieldLabel' => __('modules.employees.createLinkLabel')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'allowAnyEmail','checked' => 'true','fieldLabel' => __('modules.employees.allowAnyEmail'),'fieldName' => 'allow_email','fieldValue' => 'any'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                    ...
                                    <div class="form-check-inline custom-control custom-radio my-3 mr-3">
                                        ...
                                        <label class="custom-control-label cursor-pointer" for="onlyAllowEmail">
                                            <?php echo app('translator')->get('modules.employees.onlyAllow'); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-2 tagify_tags']); ?>
                                                ...
                                                <input type="text" name="email_domain" id="email_domain"
                                                       placeholder="<?php echo app('translator')->get('placeholders.emailDomain'); ?>"
                                                       value="<?php echo e($companyDomain[1]); ?>"
...
<?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php if (isset($component)) { $__componentOriginalcf8d12533ff890e0d6573daf32b7618d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d = $attributes; } ?>
<?php $component = App\View\Components\Forms\ButtonPrimary::resolve(['icon' => 'link'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.button-primary'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\ButtonPrimary::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'create-link']); ?>
                                    <?php echo app('translator')->get('modules.employees.createLink'); ?>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <button type="button" data-clipboard-target="#invitation-link-text"
                                    ...
                                    <i class="fa fa-copy"></i> <?php echo app('translator')->get('app.copyAboveLink'); ?>
                                </button>
                            </div>
                        </div>
                     <?php echo $__env->renderComponent(); ?>
...
<script>
    ...
    $('#send-invite').click(function () {
        var url = "<?php echo e(route('employees.send_invite')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('#create-link').click(function () {
        var url = "<?php echo e(route('employees.create_link')); ?>";
        $.easyAjax({
            url: url,
            ...
            success: function (response) {
                if (response.status == 'success') {
                    var inviteLink =
                        "<h5 class='mt-4'><?php echo e(__('messages.inviteLinkSuccess')); ?></h5>" +
    ...
    clipboard.on('success', function (e) {
        Swal.fire({
            icon: 'success',
            text: "<?php echo e(__('messages.inviteLinkCopied')); ?>",
            toast: true,
            position: 'top-end',
            timer: 3000,
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/employees/ajax/invite_member.blade.php ENDPATH**/ ?>