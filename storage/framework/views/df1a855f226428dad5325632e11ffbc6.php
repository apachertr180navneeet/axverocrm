...
<header class="px-4 bg-white sticky-top d-flex justify-content-center align-items-center login_header">
    <img class="mr-2 rounded" src="<?php echo e(asset('img/kactto-logo.jpg')); ?>" alt="KACTTO Logo" style="height: 90px !important; max-height: none !important;">
    <!--<h3 class="mb-0 pl-1">-->
    <!--    KACTTO-->
    <!--</h3>-->
</header>
...
<section class="py-5 bg-grey login_section"
         <div style="background: url('<?php echo e(asset('img/kactto-logo.jpg')); ?>') center center / cover no-repeat;">
    <div class="container">
        <div class="row">
...
<?php /**PATH /home/u566596326/domains/hreomshopping.in/public_html/resources/views/components/auth.blade.php ENDPATH**/ ?>