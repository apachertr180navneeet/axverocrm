    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-flex align-items-center">
                <?php if(in_array('clients', user_modules()) && ($addContractPermission == 'all' || $addContractPermission == 'added')): ?>
...
<?php endif; ?>
                ...
                <?php if(in_array('clients', user_modules()) && ($manageContractTemplatePermission == 'all' || $manageContractTemplatePermission == 'added')): ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $('body').on('click', '.sign-modal', function() {
            var id = $(this).data('contract-id');
            url = "<?php echo e(route('companySignStore.sign', ':id')); ?>";
            url = url.replace(':id', id);
            console.log(url);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/contracts/index.blade.php ENDPATH**/ ?>