...
<?php $component->withAttributes(['id' => 'save-department-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-bottom-grey">
                    <?php echo app('translator')->get('modules.department.addTitle'); ?></h4>
                <div class="row p-20">
                    <div class="col-md-6">
...
<?php /**PATH /home/u536896586/domains/crmaxvero.in/public_html/resources/views/departments/ajax/create.blade.php ENDPATH**/ ?>