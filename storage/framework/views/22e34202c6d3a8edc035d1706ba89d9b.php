                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-end pe-4">
                        ...
                        <form action="<?php echo e(route('offer-letters.delete', $letter->id)); ?>" method="POST" class="d-inline"
                        ...
                        <!-- <a href="<?php echo e(route('offer-letters.delete', $letter->id)); ?>"-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536896586/domains/crmaxvero.in/public_html/resources/views/offer-letter/list.blade.php ENDPATH**/ ?>