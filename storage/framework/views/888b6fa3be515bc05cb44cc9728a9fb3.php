...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-training-attendance-form','action' => ''.e(route('training.attendance.store')).'','enctype' => 'multipart/form-data']); ?>
...
<?php $component = App\View\Components\Forms\Email::resolve(['fieldLabel' => 'Company Email ID','fieldName' => 'company_email','fieldId' => 'company_email','fieldValue' => ''.e(user()->email).'','fieldPlaceholder' => 'Enter company email','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => 'Senior Name','fieldName' => 'senior_name','fieldId' => 'senior_name','fieldValue' => ''.e($reportingTo->name ?? '').'','fieldPlaceholder' => 'Senior Name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="col-md-6 mt-3">
                    <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => 'Training Date','fieldName' => 'training_date','fieldId' => 'training_date','fieldPlaceholder' => 'Select training date','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Forms\File::resolve(['fieldLabel' => 'Upload Training Image','fieldName' => 'training_image','fieldId' => 'training_image','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-training-attendance-btn']); ?>
                    Save
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
$(document).ready(function () {
    ...
    $('#save-training-attendance-btn').click(function (e) {
        ...
        $.easyAjax({
            url: "<?php echo e(route('training.attendance.store')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/reports/training/create.blade.php ENDPATH**/ ?>