...
<?php $component->withAttributes(['id' => 'save-lead-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-bottom-grey">
                    <?php echo app('translator')->get('app.menu.editdesignation'); ?></h4>
                    <div class="row p-20">
                        <div class="col-md-6">
                            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'designation_name','fieldLabel' => __('app.name'),'fieldName' => 'designation_name','fieldValue' => $designation->name,'fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.designation')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                <select class="form-control select-picker" name="parent_id" id="parent_id"
                                    ...
                                    <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($designation->id != $designations->id): ?>
                                            <option value="<?php echo e($designations->id); ?>" <?php if($designation->parent_id == $designations->id): ?> selected <?php endif; ?>><?php echo e($designations->name); ?></option>
                                        <?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-leave-form').click(function() {
            ...
            const url = "<?php echo e(route('designations.update', $designation->id)); ?>";
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/designation/ajax/edit.blade.php ENDPATH**/ ?>