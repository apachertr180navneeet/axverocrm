...
<table>
<tr><td class="label">Designation</td><td><?php echo e($kit->designation); ?></td></tr>
<tr><td class="label">Joining Date</td><td><?php echo e($kit->joining_date); ?></td></tr>
<tr><td class="label">Full Name</td><td><?php echo e($kit->first_name); ?> <?php echo e($kit->last_name); ?></td></tr>
<tr><td class="label">Email</td><td><?php echo e($kit->email); ?></td></tr>
<tr><td class="label">Mobile</td><td><?php echo e($kit->mobile); ?></td></tr>
<tr><td class="label">Gender</td><td><?php echo e($kit->gender); ?></td></tr>
<tr><td class="label">DOB</td><td><?php echo e($kit->dob); ?></td></tr>
<tr><td class="label">Marital Status</td><td><?php echo e($kit->marital_status); ?></td></tr>
<tr>
    <td class="label">Permanent Address</td>
    <td><?php echo e($kit->perm_street); ?>, <?php echo e($kit->perm_city); ?>, <?php echo e($kit->perm_state); ?> - <?php echo e($kit->perm_zip); ?>, <?php echo e($kit->perm_country); ?></td>
</tr>
<tr>
    <td class="label">Current Address</td>
    <td><?php echo e($kit->curr_street); ?>, <?php echo e($kit->curr_city); ?>, <?php echo e($kit->curr_state); ?> - <?php echo e($kit->curr_zip); ?>, <?php echo e($kit->curr_country); ?></td>
</tr>
<tr>
    <td class="label">Photos</td>
    <td>
        <div class="img-container">
            <?php if($kit->photo_full): ?>
                <img src="<?php echo e(public_path($kit->photo_full)); ?>">
            <?php endif; ?>
            <?php if($kit->photo_passport): ?>
                <img src="<?php echo e(public_path($kit->photo_passport)); ?>">
            <?php endif; ?>
        </div>
    </td>
</tr>
...
<table>
<tr><td class="label">Aadhar Number</td><td><?php echo e($kit->aadhar_number); ?></td></tr>
<tr><td class="label">PAN Number</td><td><?php echo e($kit->pan_number); ?></td></tr>
<tr>
    <td class="label">Aadhar Front</td>
    <td><div class="img-container"><?php if($kit->aadhar_front): ?><img src="<?php echo e(public_path($kit->aadhar_front)); ?>"><?php endif; ?></div></td>
</tr>
<tr>
    <td class="label">Aadhar Back</td>
    <td><div class="img-container"><?php if($kit->aadhar_back): ?><img src="<?php echo e(public_path($kit->aadhar_back)); ?>"><?php endif; ?></div></td>
</tr>
<tr>
    <td class="label">PAN Card</td>
    <td><div class="img-container"><?php if($kit->pan_image): ?><img src="<?php echo e(public_path($kit->pan_image)); ?>"><?php endif; ?></div></td>
</tr>
</table>
...
<tr>
    ...
    <td>
        <?php $__currentLoopData = $tenth ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            Year: <?php echo e($edu['year'] ?? ''); ?>, %: <?php echo e($edu['percentage'] ?? ''); ?>, Board: <?php echo e($edu['board'] ?? ''); ?> <br>
...
<tr>
    ...
    <td>
        <?php $__currentLoopData = $graduation ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($edu['degree'] ?? ''); ?> - Year: <?php echo e($edu['year'] ?? ''); ?>, College: <?php echo e($edu['college'] ?? ''); ?> <br>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </td>
</tr>
<tr>
    ...
    <td>
        <div class="img-container">
            <?php $__currentLoopData = $certificates ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <img src="<?php echo e(public_path($file)); ?>">
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </td>
</tr>
...
<table>
<tr><td class="label">Status</td><td><?php echo e($kit->exp_type); ?></td></tr>
<tr>
    ...
    <td>
        <?php $__currentLoopData = $experience ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            Company: <?php echo e($exp['company'] ?? ''); ?> <br>
            Designation: <?php echo e($exp['designation'] ?? ''); ?> <br>
            From: <?php echo e($exp['from'] ?? ''); ?> To: <?php echo e($exp['to'] ?? ''); ?> <br><br>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </td>
</tr>
<tr>
    ...
    <td>
        <div class="img-container">
            <?php if($kit->exp_certificate): ?><img src="<?php echo e(public_path($kit->exp_certificate)); ?>"><?php endif; ?>
            <?php if($kit->relieving_letter): ?><img src="<?php echo e(public_path($kit->relieving_letter)); ?>"><?php endif; ?>
        </div>
    </td>
</tr>
</table>
...
<table>
<tr><td class="label">Bank Name</td><td><?php echo e($kit->bank_name); ?></td></tr>
<tr><td class="label">Account Holder</td><td><?php echo e($kit->acc_holder); ?></td></tr>
<tr><td class="label">Account Number</td><td><?php echo e($kit->acc_number); ?></td></tr>
<tr><td class="label">IFSC</td><td><?php echo e($kit->ifsc); ?></td></tr>
<tr>
    <td class="label">Passbook</td>
    <td><div class="img-container"><?php if($kit->passbook): ?><img src="<?php echo e(public_path($kit->passbook)); ?>"><?php endif; ?></div></td>
</tr>
...
<tr>
    ...
    <td style="font-weight:bold; color: <?php echo e($kit->tnc_accepted ? 'green' : 'red'); ?>;">
        <?php echo e($kit->tnc_accepted ? '✔ Yes' : '✘ No'); ?>

    </td>
</tr>
<?php if($kit->tnc_accepted_at): ?>
<tr>
    <td class="label">Accepted On</td>
    <td><?php echo e(\Carbon\Carbon::parse($kit->tnc_accepted_at)->format('d M Y h:i A')); ?></td>
</tr>
<?php endif; ?>
</table>

</body>
</html><?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/joiningkit_pdf.blade.php ENDPATH**/ ?>