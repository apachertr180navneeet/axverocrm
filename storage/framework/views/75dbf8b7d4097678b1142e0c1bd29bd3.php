...
<div class="row">
   ...
   <div class="col-md-6">
    ...
    <?php endif; ?>
        ...
        <input type="hidden" name="designation" value="<?php echo e($invite->designation_id); ?>">
    </div>
</div>
    ...
    <textarea name="address"
            ...
            <div class="form-group text-left">
                ...
                <input type="text" name="password" class="form-control height-50 f-15 light_text"
                       placeholder="<?php echo app('translator')->get('placeholders.password'); ?>" id="password" value="Kacttonew@2026#" readonly>
            </div>
...
<?php endif; ?>
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/auth/invitation.blade.php ENDPATH**/ ?>