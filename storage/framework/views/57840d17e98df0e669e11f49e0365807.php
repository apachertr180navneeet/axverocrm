      ...
      <div class="col-md-9">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form method="POST" action="<?php echo e(route('hiring.store')); ?>" id="hiringForm">
              <?php echo csrf_field(); ?>
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="name" class="form-control readonly-field"
                    value="<?php echo e(old('name', $userData['name'] ?? '')); ?>" readonly required>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="required">Mobile Number</label>
                  <input type="text" name="mobile" class="form-control readonly-field"
                    value="<?php echo e(old('mobile', $userData['mobile'] ?? '')); ?>" readonly required>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="required">Portal Email ID</label>
                  <input type="email" name="portal_email" class="form-control readonly-field"
                    value="<?php echo e(old('portal_email', $userData['portal_email'] ?? '')); ?>" readonly required>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" name="designation" class="form-control"
                    value="<?php echo e(old('designation', $userData['designation'] ?? '')); ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="required">Department</label>
                  <input type="text" name="department" class="form-control"
                    value="<?php echo e(old('department', $userData['department'] ?? '')); ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="required">Senior Manager Name</label>
                  <input type="text" name="senior_manager_name" class="form-control"
                    value="<?php echo e(old('senior_manager_name', $userData['senior_manager_name'] ?? '')); ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="required">Senior Manager Mobile</label>
                  <input type="text" name="senior_manager_mobile" class="form-control"
                    value="<?php echo e(old('senior_manager_mobile', $userData['senior_manager_mobile'] ?? '')); ?>" required>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-2">
                    ...
                    <input type="text" name="hiring_work_details[1][name]" class="form-control"
                      value="<?php echo e(old('hiring_work_details.1.name')); ?>">
                  </div>
                  <div class="col-md-6 mb-2">
                    <label>Mobile</label>
                    <input type="text" name="hiring_work_details[1][mobile]" class="form-control"
                      placeholder="9876543210" value="<?php echo e(old('hiring_work_details.1.mobile')); ?>">
                  </div>
                  <div class="col-md-6 mb-2">
                    <label>Portal Email ID</label>
                    <input type="email" name="hiring_work_details[1][portal_email]" class="form-control"
                      value="<?php echo e(old('hiring_work_details.1.portal_email')); ?>">
                  </div>
                  <div class="col-md-6 mb-2">
                    <label>Joining Date</label>
                    <input type="date" name="hiring_work_details[1][joining_date]" class="form-control"
                      value="<?php echo e(old('hiring_work_details.1.joining_date')); ?>">
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-2">
                    ...
                    <input type="text" name="hiring_work_details[2][name]" class="form-control"
                      value="<?php echo e(old('hiring_work_details.2.name')); ?>">
                  </div>
                  <div class="col-md-6 mb-2">
                    <label>Mobile</label>
                    <input type="text" name="hiring_work_details[2][mobile]" class="form-control"
                      placeholder="9876543210" value="<?php echo e(old('hiring_work_details.2.mobile')); ?>">
                  </div>
                  <div class="col-md-6 mb-2">
                    <label>Portal Email ID</label>
                    <input type="email" name="hiring_work_details[2][portal_email]" class="form-control"
                      value="<?php echo e(old('hiring_work_details.2.portal_email')); ?>">
                  </div>
                  <div class="col-md-6 mb-2">
                    <label>Joining Date</label>
                    <input type="date" name="hiring_work_details[2][joining_date]" class="form-control"
                      value="<?php echo e(old('hiring_work_details.2.joining_date')); ?>">
                  </div>
                </div>
              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536896586/domains/kactto.space/public_html/resources/views/hiring/create.blade.php ENDPATH**/ ?>