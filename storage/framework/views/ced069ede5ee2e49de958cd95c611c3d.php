...
<?php $component->withAttributes([]); ?>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 " for="usr"><?php echo app('translator')->get('modules.employees.gender'); ?></label>
                <div class="select-filter mb-4">
                    <div class="select-others">
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 " for="usr"><?php echo app('translator')->get('modules.employees.employmentType'); ?></label>
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="employmentType" id="employmentType" data-container="body">
                            <option value="all"><?php echo app('translator')->get('app.all'); ?></option>
                            <option value="probation"><?php echo app('translator')->get('app.onProbation'); ?></option>
                            <option value="internship"><?php echo app('translator')->get('app.onInternship'); ?></option>
                            <option value="notice_period"><?php echo app('translator')->get('app.onNoticePeriod'); ?></option>
                            <option value="new_hires"><?php echo app('translator')->get('app.newHires'); ?></option>
                            <option value="long_standing"><?php echo app('translator')->get('app.longStanding'); ?></option>
...
<?php $component->withAttributes(['class' => 'mr-3 invite-member mb-2 mb-lg-0']); ?>
                        <?php echo app('translator')->get('app.inviteEmployee'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad)): ?>
<?php $attributes = $__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 openRightModal mb-2 mb-lg-0 d-none d-lg-block']); ?>
...
$('body').on('change', '.change-letter-status', function () {
    ...
    $.easyAjax({
        url: "<?php echo e(route('employees.update_letter_status')); ?>",
        type: "POST",
        data: {
...
$('body').on('change', '.change-premium-status', function () {
    var id = $(this).data('id');
    var status = $(this).is(':checked') ? 1 : 0;

    $.easyAjax({
        url: "<?php echo e(route('employees.update_premium_status')); ?>",
        type: "POST",
        data: {
            _token: "<?php echo e(csrf_token()); ?>",
            id: id,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/employees/index.blade.php ENDPATH**/ ?>