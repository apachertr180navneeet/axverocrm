...
<?php $component->withAttributes(['id' => 'save-lead-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-bottom-grey">
                    <?php echo app('translator')->get('modules.deal.dealDetails'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-4 ">
                        <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'lead_contact','fieldLabel' => __('modules.leadContact.leadContacts'),'fieldName' => 'lead_contact','fieldRequired' => 'true','search' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                            ...
                            <?php $__currentLoopData = $leadContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leadContact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                    <?php if(!is_null($contactID) && $contactID == $leadContact->id): echo 'selected'; endif; ?>  value="<?php echo e($leadContact->id); ?>">
...
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $leadPipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                    <?php if(!is_null($stage) && $stage->lead_pipeline_id == $pipeline->id): echo 'selected'; endif; ?>  value="<?php echo e($pipeline->id); ?>">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#save-more-lead-form').click(function () {
            $('#add_more').val(true);
            const url = "<?php echo e(route('deals.store')); ?>?add_more=true";
        ...
        $('#save-lead-form').click(function () {
            const url = "<?php echo e(route('deals.store')); ?>";
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/leads/ajax/create.blade.php ENDPATH**/ ?>