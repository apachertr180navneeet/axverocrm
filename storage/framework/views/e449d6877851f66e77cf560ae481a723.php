...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($role->id); ?>">
                ...
                <td data-row-id="<?php echo e($role->id); ?>"  contenteditable="true" placeholder="Edit me..." ><?php echo e($role->display_name); ?>
...
<?php $component->withAttributes(['class' => 'reset-permission ml-2','data-role-id' => ''.e($role->id).'']); ?>
                                <?php echo app('translator')->get('app.resetPermissions'); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad)): ?>
<?php $attributes = $__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad; ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'role_name','fieldLabel' => __('modules.permission.roleName'),'fieldName' => 'name','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.role.roleName')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/u566596326/domains/hreomshopping.in/public_html/resources/views/role-permissions/ajax/create.blade.php ENDPATH**/ ?>