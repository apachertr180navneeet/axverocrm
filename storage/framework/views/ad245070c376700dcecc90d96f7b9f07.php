                        ...
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <?php if($manageGroupPermission == 'all'): ?>
                                <a class="nav-item nav-link f-15 group-manage"
                                    href="<?php echo e(route('ticket-settings.index')); ?>?tab=group-manage" role="tab"
                                    aria-controls="nav-groupManage" aria-selected="true"><?php echo app('translator')->get('app.menu.groupManage'); ?>
                                </a>
                            <?php endif; ?>
                            ...
                            <a class="nav-item nav-link f-15 method"
                                href="<?php echo e(route('ticket-settings.index')); ?>?tab=round-robin" role="tab"
                            ...
                            <a class="nav-item nav-link f-15 ticket-agent-setting"
                                href="<?php echo e(route('ticket-settings.index')); ?>?tab=ticket-agent-setting" role="tab"
                                aria-controls="nav-ticketSetting" aria-selected="true"><?php echo app('translator')->get('modules.deal.ticketVisibilitySetting'); ?>
                            </a>
...
<?php $component->withAttributes(['id' => 'addTicketType','class' => 'type-btn mb-2 d-none actionBtn']); ?>
                            <?php echo app('translator')->get('app.addNewTicketType'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['id' => 'addAgent','class' => 'agent-btn mb-2 d-none actionBtn']); ?>
                            <?php echo app('translator')->get('app.addNewAgents'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $component->withAttributes(['id' => 'addChannel','class' => 'channel-btn mb-2 d-none actionBtn']); ?>
                            <?php echo app('translator')->get('app.addNewTicketChannel'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $component->withAttributes(['id' => 'addReplyTemplate','class' => 'reply-template-btn mb-2 d-none actionBtn']); ?>
                            <?php echo app('translator')->get('modules.projectTemplate.addNewTemplate'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addGroup','class' => 'group-manage-btn mb-2 d-none actionBtn']); ?>
                            <?php echo app('translator')->get('app.addNewGroup'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
       ...
       $("body").on("click", "#editSettings .nav a", function(event) {
        ...
        $(".change-agent-group").selectpicker({
            ...
            countSelectedText: function(selected, total) {
                return selected + " <?php echo e(__('app.groupSelected')); ?> ";
            }
        });
        ...
        $('body').on('click', '.edit-group', function() {
            ...
            var url = "<?php echo e(route('ticket-groups.edit', ':id')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/ticket-settings/index.blade.php ENDPATH**/ ?>