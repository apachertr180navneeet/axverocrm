...
<?php $component->withAttributes(['id' => 'save-designation-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-bottom-grey">
                    <?php echo app('translator')->get('app.menu.addDesignation'); ?></h4>
                <div class="row p-20">
                    <div class="col-md-6">
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/designation/ajax/create.blade.php ENDPATH**/ ?>