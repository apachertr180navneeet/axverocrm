...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'submit-login','class' => 'otp-submit']); ?><?php echo app('translator')->get('modules.twofactor.validate2FA'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/security-settings/ajax/validate-email-confirm-modal.blade.php ENDPATH**/ ?>