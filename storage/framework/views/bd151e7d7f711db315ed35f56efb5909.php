            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <label class="f-14 text-dark-grey mb-12 w-100" for="usr"><?php echo app('translator')->get('modules.holiday.officeHolidayMarkDays'); ?></label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.weeks','data' => ['fieldName' => 'office_holiday_days[]','fieldRequired' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['fieldName' => 'office_holiday_days[]','fieldRequired' => 'true']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u536896586/domains/crmaxvero.in/public_html/resources/views/holiday/mark-holiday/index.blade.php ENDPATH**/ ?>