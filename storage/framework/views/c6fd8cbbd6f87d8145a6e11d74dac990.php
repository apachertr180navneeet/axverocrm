...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'sign_up_term','popover' => __('app.signUpTermsNote'),'fieldLabel' => __('app.showSignUpTerms')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            <div class="custom-control custom-switch">
                                <input type="checkbox"
                                    <?php if($global->sign_up_terms == 'yes'): ?> checked <?php endif; ?>
                    ...
                    <div class="col-md-4 mb-3 <?php if($global->sign_up_terms == 'no'): ?> d-none <?php endif; ?>" id="terms_link_div">
                        <div class="form-group mb-lg-0 mb-md-0 mb-4">
                            <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'terms_link','fieldLabel' => __('app.showSignUpTerms'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
                            <div class="input-group">
                                <input type="text" name="terms_link"
                                    ...
                                    placeholder="<?php echo app('translator')->get('placeholders.url'); ?>" value="<?php echo e($global->terms_link); ?>">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        $('#save-form').click(function () {
            var url = "<?php echo e(route('sign-up-settings.update', company()->id)); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/sign-up-settings/index.blade.php ENDPATH**/ ?>