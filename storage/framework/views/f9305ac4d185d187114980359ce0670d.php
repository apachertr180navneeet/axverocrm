...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-employee-report-form','action' => ''.e(route('employee_task.report.store')).'']); ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'status','fieldLabel' => ''.e(__('app.status')).'','fieldName' => 'status','search' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                        <option value="incomplete"
                            <?php echo e(old('status') == 'incomplete' ? 'selected' : ''); ?>

                            data-content="<i class='fa fa-circle mr-2 text-red'></i> <?php echo e(__('app.incomplete')); ?>">
                            <?php echo e(__('app.incomplete')); ?>

                        </option>
                        
                        <option value="to_do"
                            <?php echo e(old('status') == 'to_do' ? 'selected' : ''); ?>
                        ...
                        <option value="doing"
                            <?php echo e(old('status') == 'doing' ? 'selected' : ''); ?>
                        ...
                        <option value="completed"
                            ...
                            data-content="<i class='fa fa-circle mr-2 text-dark-green'></i> <?php echo e(__('app.completed')); ?>">
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => 'Reports','fieldName' => 'reports','fieldId' => 'report_text','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-employee-report-btn').click(function(e) {
            ...
            const url = "<?php echo e(route('employee_task.report.store')); ?>";
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        window.location.href = response.redirectUrl ?? "<?php echo e(route('employee.report.index')); ?>";
                    }
                }
            });
        });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u566596326/domains/hreomshopping.in/public_html/resources/views/reports/employee-task/create.blade.php ENDPATH**/ ?>