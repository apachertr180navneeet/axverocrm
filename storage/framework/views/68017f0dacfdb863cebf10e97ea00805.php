...
<?php $component->withAttributes([]); ?>
        ...
        <div class="more-filter-items">
            <label class="f-14 text-dark-grey mb-12 " for="usr"><?php echo app('translator')->get('modules.lead.leadOwner'); ?></label>
            <div class="select-filter mb-4">
                <div class="select-others">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/lead-contact/filters.blade.php ENDPATH**/ ?>