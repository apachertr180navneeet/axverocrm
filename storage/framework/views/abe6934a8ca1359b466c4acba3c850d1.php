        ...
        <div class="col-sm-12">
            <div class="card bg-white border-0 b-shadow-4">
                <div class="card-header bg-white  border-bottom-grey  justify-content-between p-20">
                    <div class="row">
                        <div class="col-10">
                            <h3 class="heading-h1 mb-3"><?php echo app('translator')->get('app.noteDetails'); ?></h3>
                        </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                    ...
                                    <a class="dropdown-item openRightModal"
                                        href="<?php echo e(route('sticky-notes.edit', $stickyNotes->id)); ?>"><?php echo app('translator')->get('app.edit'); ?></a>
                                    <a class="dropdown-item delete-snote"
                                        data-note-id="<?php echo e($stickyNotes->id); ?>"><?php echo app('translator')->get('app.delete'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $component = App\View\Components\Cards\DataRow::resolve(['label' => __('modules.sticky.colors'),'value' => '<i class=\'fa fa-square f-21 mr-2 text-'.e($colour).'\'></i>','html' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginalfc012cd47eee5094db538668bc6edefd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfc012cd47eee5094db538668bc6edefd = $attributes; } ?>
<?php $component = App\View\Components\Cards\DataRow::resolve(['label' => __('app.note'),'value' => $stickyNotes->note_text,'html' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('cards.data-row'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Cards\DataRow::class))->getConstructor()): ?>
    ...
    $('body').on('click', '.delete-snote', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "<?php echo e(route('sticky-notes.destroy', $stickyNotes->id)); ?>";
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/sticky-notes/ajax/show.blade.php ENDPATH**/ ?>