...
<?php $component->withAttributes(['type' => 'info','icon' => 'info-circle']); ?>
        <?php echo app('translator')->get('messages.leaveQuotaShowing', ['start_date' => $leaveStartDate, 'end_date' => $leaveEndDate]); ?>
...
<?php $component->withAttributes(['class' => 'table-bordered mb-3 rounded']); ?>
                            ...
                            <?php $__currentLoopData = $employeeLeavesQuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $leavesQuota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($leavesQuota->leaveType && $leavesQuota->leaveType->leaveTypeCondition($leavesQuota->leaveType,  $employee)
...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.leaves.leaveTypeImpacttrue'),'fieldName' => 'allowed_impact','fieldId' => 'allowed_probation-'.e($leavesQuota->id).'','fieldValue' => '0','checked' => $leavesQuota->leave_type_impact == 1,'popover' => __('modules.leaves.leavemanageimpact')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['fieldRequired' => 'false']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u566596326/domains/hreomshopping.in/public_html/resources/views/employees/ajax/leaves_quota.blade.php ENDPATH**/ ?>