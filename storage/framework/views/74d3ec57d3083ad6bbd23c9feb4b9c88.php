<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.addNewTicketAgents'); ?></h5>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'agent_id','fieldLabel' => __('modules.tickets.chooseAgents'),'fieldName' => 'user_id','search' => 'true','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\UserOption::resolve(['user' => $emp] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="col-md-6">
                    <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'ticket_group_id','fieldLabel' => __('modules.tickets.assignGroup'),'fieldName' => 'group_id[]','search' => 'true','fieldRequired' => 'true','multiple' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Select::class))->getConstructor()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-agent']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-agent').click(function() {
        $.easyAjax({
            url: "<?php echo e(route('ticket-agents.store')); ?>",
    ...
    $(document).on('change', '#agent_id', function() {
        ...
        function agentGroups(agentId) {
            $.easyAjax({
                url: "<?php echo e(route('ticket_agents.agent_groups')); ?>",
                container: '#createMethods',
                type: "GET",
                blockUI: true,
...
<?php /**PATH /home/u536896586/domains/crmaxvero.in/public_html/resources/views/ticket-settings/create-agent-modal.blade.php ENDPATH**/ ?>