...
<?php $component->withAttributes([]); ?>
                                <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($currency->id == company()->currency_id): echo 'selected'; endif; ?>  value="<?php echo e($currency->id); ?>" data-currency-name="<?php echo e($currency->currency_code); ?>">
...
<?php $component = App\View\Components\Forms\File::resolve(['fieldLabel' => __('app.bill'),'fieldName' => 'bill','fieldId' => 'bill','allowedFileExtensions' => 'txt pdf doc xls xlsx docx rtf png jpg jpeg svg','popover' => __('messages.fileFormat.multipleImageFile')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/expenses/ajax/create.blade.php ENDPATH**/ ?>