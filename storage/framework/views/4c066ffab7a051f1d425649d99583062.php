...
<?php endif; ?>
        ...
        <?php if(isWorksuiteSaas()): ?>
            <div class="col-lg-6 col-md-6 smtp_div">
                <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'email_verified','fieldLabel' => __('modules.emailSettings.emailVerified'),'fieldName' => 'email_verified','fieldRequired' => 'true','popover' => __('modules.emailSettings.emailVerifiedInfo')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Select::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <option <?php if($smtpSetting->email_verified): ?> selected <?php endif; ?> value="1">
                        <?php echo app('translator')->get('app.yes'); ?>
                    </option>
                    <option <?php if(!$smtpSetting->email_verified): ?> selected <?php endif; ?> value="0">
...
<div class="col-xl-4 col-lg-12 col-md-12 ntfcn-tab-content-right border-left-grey p-4">
    <h4 class="f-16  f-w-500 text-dark-grey"><?php echo app('translator')->get("modules.emailSettings.notificationTitle"); ?></h4>
...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['checked' => $checkedAll==true,'fieldLabel' => __('modules.permission.selectAll'),'fieldName' => 'select_all_checkbox','fieldId' => 'select_all','fieldValue' => 'all'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/u536896586/domains/kactto.space/public_html/resources/views/notification-settings/ajax/email-setting.blade.php ENDPATH**/ ?>