...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'subject','fieldLabel' => __('app.subject'),'fieldName' => 'subject','fieldValue' => ($contract ? $contract->subject : ''),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            <div id="description"><?php echo $contract ? $contract->contract_detail : ''; ?></div>
...
<?php $component->withAttributes([]); ?>
                            <select class="form-control select-picker" name="contract_type" id="contractType"
                                ...
                                <?php $__currentLoopData = $contractTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($contract && $item->id == $contract->contract_type_id): ?> selected <?php endif; ?> value="<?php echo e($item->id); ?>">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <input type="number" min="0" name="amount" value="<?php echo e($contract->amount ?? ''); ?>"
...
<?php $component = App\View\Components\Forms\ButtonCancel::resolve(['link' => route('contract-template.index')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-contract-form').click(function() {
            ...
            const url = "<?php echo e(route('contract-template.store')); ?>";
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/contract-template/ajax/create.blade.php ENDPATH**/ ?>