...
<?php endif; ?>
    ...
    <input type="tel" class="form-control height-35 f-14" placeholder="<?php echo e($fieldPlaceholder); ?>"
           value="<?php echo e($fieldValue); ?>" name="<?php echo e($fieldName); ?>" id="<?php echo e($fieldId); ?>">
</div>
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/components/forms/tel.blade.php ENDPATH**/ ?>