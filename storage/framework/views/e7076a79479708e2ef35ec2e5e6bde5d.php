                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 push-notification-setting"
                                ...
                                class="fa fa-circle ml-1 <?php echo e(($pushSettings->status == 'active' || $pushSettings->beams_push_status == 'active') ? 'text-light-green' : 'text-red'); ?>"></i>
                            </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536896586/domains/kactto.space/public_html/resources/views/notification-settings/index.blade.php ENDPATH**/ ?>