...
<?php endif; ?>
                ...
                <td>
                    <select class="change-agent-group form-control select-picker" data-agent-id="<?php echo e($agent->id); ?>" multiple name="groupId[]">
                        <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option
                                <?php $__currentLoopData = $agent->agentGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td>
                    <select class="change-agent-status form-control select-picker" data-agent-id="<?php echo e($agent->id); ?>">
                        <option <?php if($agent->agent[0]->status == 'enabled'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.enabled'); ?></option>
                        <option <?php if($agent->agent[0]->status == 'disabled'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.disabled'); ?></option>
                    </select>
                </td>
                <td class="text-right">
                    <div class="task_view">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/ticket-settings/ajax/agent.blade.php ENDPATH**/ ?>