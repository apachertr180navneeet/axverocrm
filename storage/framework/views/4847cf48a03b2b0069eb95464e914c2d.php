...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg bmp','fieldLabel' => __('modules.profile.profilePicture'),'fieldValue' => ($user->image ? $user->masked_image_url : $user->image_url),'fieldName' => 'image','fieldId' => 'profile-image','popover' => __('modules.themeSettings.logoSize')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
            ...
            <div class="input-group">
                <select class="select-picker form-control" name="salutation" id="salutation"
                    ...
                    <?php $__currentLoopData = $salutations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salutation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($salutation->value); ?>" <?php if($user->salutation == $salutation): echo 'selected'; endif; ?>><?php echo e($salutation->label()); ?></option>
...
<?php endif; ?>
        ...
        <div class="col-lg-4">
            <div class="my-3 form-group">
                <label class="mb-12 f-14 text-dark-grey w-100" for="usr"><?php echo app('translator')->get('app.googleCalender'); ?></label>
                <div class="d-flex">
                    <?php if (isset($component)) { $__componentOriginalc709ddc147ddde534205d9546b4fb0db = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc709ddc147ddde534205d9546b4fb0db = $attributes; } ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'country_id','fieldLabel' => __('app.country'),'fieldName' => 'country_id','search' => 'true','alignRight' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option data-tokens="<?php echo e($item->iso3); ?>" data-phonecode="<?php echo e($item->phonecode); ?>" data-iso="<?php echo e($item->iso); ?>"
...
<?php $component->withAttributes([]); ?>
                <?php $__currentLoopData = $languageSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e(user()->locale == $language->language_code ? 'selected' : ''); ?>
                            ...
                            data-content="<span class='flag-icon flag-icon-<?php echo e(($language->flag_code == 'en') ? 'gb' : $language->flag_code); ?> flag-icon-squared'></span> <?php echo e($language->language_name . ($language->is_rtl == 1 ? ' (' . __('app.rtl') . ')' : '')); ?>"
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <option <?php if($user->gender == 'male'): echo 'selected'; endif; ?> value="male"><?php echo app('translator')->get('app.male'); ?></option>
                <option <?php if($user->gender == 'female'): echo 'selected'; endif; ?> value="female"><?php echo app('translator')->get('app.female'); ?></option>
                <option <?php if($user->gender == 'others'): echo 'selected'; endif; ?> value="others"><?php echo app('translator')->get('app.others'); ?></option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal67cd5dc9866c6185ad92d933c387fa86)): ?>
<?php $attributes = $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86; ?>
...
<?php endif; ?>
        ...
        <?php if($socialAuthSettings->twitter_status == 'enable'): ?>
            <div class="col-lg-4">
                <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.profile.twitterId'),'fieldPlaceholder' => __('placeholders.twitterId'),'fieldName' => 'twitter_id','fieldId' => 'twitter_id','fieldValue' => $user->twitter_id] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $component->withAttributes(['fieldPlaceholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('placeholders.date'))]); ?>
                        <?php $__currentLoopData = \App\Enums\MaritalStatus::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($user->employeeDetail->marital_status == $status): echo 'selected'; endif; ?>
...
<?php endif; ?>
                ...
                <p class="text-bold"><span id="telegram-link-text">https://t.me/<?php echo e(sms_setting()->telegram_bot_name); ?></span>
                    <a href="javascript:;" class="p-1 py-2 ml-1 rounded btn-copy btn-secondary f-12"
                        ...
                        <i class="mx-1 fa fa-copy"></i><?php echo app('translator')->get('app.copy'); ?></a>
                    <a href="https://t.me/<?php echo e(sms_setting()->telegram_bot_name); ?>" target="_blank" class="p-1 py-2 ml-1 rounded btn-secondary f-12">
                        <i class="mx-1 fa fa-copy"></i><?php echo app('translator')->get('app.openInNewTab'); ?></a>
                </p>
            </div>
        <?php endif; ?>
    ...
    $(document).ready(function () {
        ...
        <?php if(!in_array('client', user_roles())): ?>
            datepicker('#date_of_birth', {
                position: 'bl',
                maxDate: new Date(),
                <?php if(!is_null($user->employeeDetail->date_of_birth)): ?>
...
<?php /**PATH /home/u566596326/domains/hreomshopping.in/public_html/resources/views/profile-settings/ajax/profile.blade.php ENDPATH**/ ?>