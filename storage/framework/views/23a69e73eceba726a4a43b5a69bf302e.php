...
<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.addPassport'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-passport-data-form','class' => 'ajax-form']); ?>

            <input type="hidden" value="<?php echo e(request()->empid); ?>" name="emp_id">
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.employees.passportNumber'),'fieldName' => 'passport_number','fieldId' => 'passport_number','fieldValue' => '','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'nationality','fieldLabel' => __('app.nationality'),'fieldName' => 'nationality','search' => 'true','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                        ...
                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option data-tokens="<?php echo e($item->iso3); ?>"
                                data-content="<span class='flag-icon flag-icon-<?php echo e(strtolower($item->iso)); ?> flag-icon-squared'></span> <?php echo e($item->nationality .' ('.  $item->name . ')'); ?>"
                                value="<?php echo e($item->id); ?>"><?php echo e($item->nationality); ?></option>
...
<?php endif; ?>
                ...
                <div class="col-lg-3">
                    <?php if (isset($component)) { $__componentOriginalf704f069031d81dfb7cf95f6709a6a66 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf704f069031d81dfb7cf95f6709a6a66 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Datepicker::resolve(['fieldId' => 'expiry_date','fieldRequired' => 'true','fieldLabel' => __('modules.employees.expiryDate'),'fieldName' => 'expiry_date','fieldValue' => now(company()->timezone)->format(company()->date_format),'fieldPlaceholder' => __('placeholders.date')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.datepicker'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Datepicker::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg pdf doc docx','fieldLabel' => __('modules.employees.scanCopy'),'fieldName' => 'file','fieldId' => 'file'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-passport-form']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-passport-form').click(function(){
        $.easyAjax({
                    url: "<?php echo e(route('passport.store')); ?>",
...
<?php /**PATH /home/u536896586/domains/kactto.space/public_html/resources/views/employees/ajax/create-passport-modal.blade.php ENDPATH**/ ?>