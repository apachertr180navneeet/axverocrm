...
<?php $__env->startSection('content'); ?>
  <div class="container-fluid advance-income">
          ...
          <div class="section-header">
              <i class="fas fa-credit-card me-2"></i> Agent Applications
          </div>

          <div class="filter-card">
              <div class="filter-title"><i class="fas fa-filter me-2"></i> Agent Applications</div>
              <form method="GET" action="<?php echo e(route('dashboard')); ?>" class="row g-3">
                  <div class="col-md-3">
                      <input type="text" name="search" class="form-control" placeholder="Search by Name, Email, Mobile, TXN ID" value="<?php echo e(request('search')); ?>">
                  </div>
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                      <select name="payment_status" class="form-control">
                          ...
                          <option value="success" <?php echo e(request('payment_status') == 'success' ? 'selected' : ''); ?>>✅ Success</option>
                  ...
                  <div class="col-md-3">
                      <div class="btn-group">
                          ...
                          <a href="<?php echo e(route('dashboard')); ?>" class="btn-secondary"><i class="fas fa-sync me-1"></i> Reset</a>
                          <a href="<?php echo e(route('export.payu.excel', request()->query())); ?>" class="btn-success"><i class="fas fa-file-excel me-1"></i> Excel</a>
                          <a href="<?php echo e(route('export.payu.pdf', request()->query())); ?>" class="btn-danger"><i class="fas fa-file-pdf me-1"></i> PDF</a>
                      </div>
                  </div>
              </form>
          </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536896586/domains/crmaxvero.in/public_html/resources/views/hiring/list.blade.php ENDPATH**/ ?>