...
<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.addNewLeaveType'); ?></h5>
...
<?php $component->withAttributes(['id' => 'createLeave','class' => 'ajax-form']); ?>
            <div class="tabs border-bottom-grey">
                <div class="nav" id="nav-tab">
                    <a class="nav-item nav-link f-15 type active" data-toggle="tab" href="#personal" role="tab" aria-controls="nav-type" aria-selected="true"><?php echo app('translator')->get('app.general'); ?></a>
                    <a class="nav-item nav-link f-15 type" data-toggle="tab" href="#promotion" role="tab" aria-controls="nav-type" aria-selected="true"><?php echo app('translator')->get('modules.leaves.entitlement'); ?></a>
                    <a class="nav-item nav-link f-15 type" data-toggle="tab" href="#vacation" role="tab" aria-controls="nav-type" aria-selected="true"><?php echo app('translator')->get('modules.leaves.applicability'); ?></a>
                </div>
            </div>
            ...
            <div class="tab-content" id="tab-content">
                    <div class="tab-pane active" id="personal">
                        ...
                        <h3 class="heading-h3 mt-4"><?php echo app('translator')->get('app.general'); ?></h3>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'leavetype','fieldLabel' => __('modules.leaves.leaveAllotmentType'),'fieldName' => 'leavetype','search' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <option value="monthly"><?php echo app('translator')->get('app.monthlyLeaveType'); ?></option>
                                    <option value="yearly"><?php echo app('translator')->get('app.yearlyLeaveType'); ?></option>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = App\View\Components\Forms\Number::resolve(['fieldLabel' => __('modules.leaves.noOfYearlyLeaves'),'fieldName' => 'yearly_leave_number','fieldId' => 'yearly_leave_number','fieldValue' => '0','minValue' => '0','popover' => __('messages.leave.noOfYearlyLeaves')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4" id="monthly-leave-field">
                                <?php if (isset($component)) { $__componentOriginal1fded940a0a5d34bf1b88a1f45916593 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1fded940a0a5d34bf1b88a1f45916593 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Number::resolve(['fieldLabel' => __('modules.leaves.noOfMonthlyLeaves'),'fieldName' => 'monthly_leave_number','fieldId' => 'monthly_leave_number','fieldValue' => '0','minValue' => '0','popover' => __('messages.leave.noOfMonthlyLeaves')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.number'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Number::class))->getConstructor()): ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4">
                                <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'paid','fieldLabel' => __('modules.leaves.leavePaidStatus'),'fieldName' => 'paid','search' => 'true','popover' => __('messages.leave.paidStatus')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Select::class))->getConstructor()): ?>
...
<?php endif; ?>
                    ...
                    <div class="tab-pane" id="promotion">
                        <h3 class="heading-h3 mt-4"><?php echo app('translator')->get('modules.leaves.entitlement'); ?></h3>

                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group my-3">
                                    <div class="d-flex align-items-center">
                                        <label class="f-14 text-dark-grey mb-12 mt-2 mr-1"><?php echo app('translator')->get('modules.leaves.effectiveAfter'); ?></label>
                                        &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                                data-content="<?php echo e(__('messages.leave.effectiveAfter')); ?>" data-trigger="hover"></i>
...
<?php endif; ?>
                                        ...
                                        <label class="f-14 text-dark-grey mb-12 mt-2"><?php echo app('translator')->get('modules.leaves.ofJoining'); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.leaves.allowedProbation'),'fieldName' => 'allowed_probation','fieldId' => 'allowed_probation','checked' => 'true','fieldValue' => '1','popover' => __('messages.leave.allowedProbation')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <div class="d-flex align-items-center">
                                        <label class="f-14 mb-12 mt-2 text-dark-grey mr-1"><?php echo app('translator')->get('modules.leaves.unusedLeaves'); ?></label>
                                        &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                                data-content="<?php echo e(__('messages.leave.unusedLeave')); ?>" data-trigger="hover"></i>
                                        <div class="col-md-6">
                                            <?php if (isset($component)) { $__componentOriginalcbf9105fd4879d5d6ef9e1f6fe271af7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcbf9105fd4879d5d6ef9e1f6fe271af7 = $attributes; } ?>
<?php $component = App\View\Components\Forms\InputGroup::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                                <select name="unused_leave" class="select-picker form-control">
                                                    <option value="carry forward"><?php echo app('translator')->get('modules.leaves.carryForward'); ?></option>
                                                    <option value="lapse"><?php echo app('translator')->get('modules.leaves.lapse'); ?></option>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <div class="d-flex align-items-center">
                                        <label class="f-14 mb-12 mt-2 text-dark-grey mr-1"><?php echo app('translator')->get('modules.leaves.overutilization'); ?></label>
                                        &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                                data-content="<?php echo e(__('messages.leave.overutilization')); ?>" data-trigger="hover"></i>
                                        <div class="col-md-7">
                                            <?php if (isset($component)) { $__componentOriginalcbf9105fd4879d5d6ef9e1f6fe271af7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcbf9105fd4879d5d6ef9e1f6fe271af7 = $attributes; } ?>
<?php $component = App\View\Components\Forms\InputGroup::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                                <select name="over_utilization" class="select-picker form-control">
                                                    <option value="not_allowed"><?php echo app('translator')->get('modules.leaves.doNotAllow'); ?></option>
                                                    <option value="allow_paid"><?php echo app('translator')->get('modules.leaves.allowPaid'); ?></option>
                                                    <option value="allow_unpaid"><?php echo app('translator')->get('modules.leaves.allowUnpaid'); ?></option>
                                                </select>
                                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcbf9105fd4879d5d6ef9e1f6fe271af7)): ?>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <div class="d-flex mt-3">
                                        <?php if (isset($component)) { $__componentOriginal9c5d7e5b2e4b8b16cfa941b5e69189f3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9c5d7e5b2e4b8b16cfa941b5e69189f3 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.leaves.allowedNotice'),'fieldName' => 'allowed_notice','fieldId' => 'allowed_notice','checked' => 'true','fieldValue' => '1','popover' => __('messages.leave.allowedNotice')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Checkbox::class))->getConstructor()): ?>
...
<?php endif; ?>
                    ...
                    <div class="tab-pane" id="vacation">
                        <h3 class="heading-h3 mt-4"><?php echo app('translator')->get('modules.leaves.applicability'); ?></h3>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'gender','fieldLabel' => __('modules.employees.gender'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="<?php echo e(__('messages.leave.gender')); ?>" data-trigger="hover"></i>
                                    <select class="form-control multiple-option" multiple name="gender[]"
                                        id="gender" data-live-search="true" data-size="8">
                                        <option value="male" selected><?php echo app('translator')->get('app.male'); ?></option>
                                        <option value="female" selected><?php echo app('translator')->get('app.female'); ?></option>
                                        <option value="others" selected><?php echo app('translator')->get('app.others'); ?></option>
                                </select>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'marital_status','fieldLabel' => __('modules.employees.maritalStatus'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="<?php echo e(__('messages.leave.maritalStatus')); ?>" data-trigger="hover"></i>
                                    <select class="form-control multiple-option" multiple name="marital_status[]"
                                        ...
                                        <?php $__currentLoopData = \App\Enums\MaritalStatus::cases(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option selected value="<?php echo e($status->value); ?>"><?php echo e($status->label()); ?></option>
...
<?php endif; ?>
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="<?php echo e(__('messages.leave.department')); ?>" data-trigger="hover"></i>
                                    <select class="form-control multiple-option" multiple name="department[]"
                                        ...
                                        <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($team->id); ?>" selected><?php echo e($team->team_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php endif; ?>
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="<?php echo e(__('messages.leave.designation')); ?>" data-trigger="hover"></i>
                                    <select class="form-control multiple-option" multiple name="designation[]"
                                        ...
                                        <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($designation->id); ?>" selected><?php echo e($designation->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'role','fieldLabel' => __('app.role'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="<?php echo e(__('messages.leave.role')); ?>" data-trigger="hover"></i>
                                    <select class="form-control multiple-option" multiple name="role[]"
                                        ...
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($roles->id); ?>" selected><?php echo e($roles->display_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php /**PATH /home/u536896586/domains/crmaxvero.in/public_html/resources/views/leave-settings/create-leave-setting-type-modal.blade.php ENDPATH**/ ?>