...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'import-employee-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-bottom-grey">
                    <?php echo app('translator')->get('app.importEmployee'); ?></h4>
                <div class="col-sm-12 pt-2">
                    <div class="alert alert-warning" role="alert">
                        <?php echo app('translator')->get('app.importExcelInfo'); ?>
                    </div>
                </div>
                <div class="row py-20">
                    <div class="col-md-12">
...
<?php $component = App\View\Components\Forms\LinkSecondary::resolve(['link' => asset('sample-import/employees-sample.xlsx'),'icon' => 'download'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo app('translator')->get('app.downloadSampleImport'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = App\View\Components\Forms\File::resolve(['fieldLabel' => __('modules.import.file'),'fieldName' => 'import_file','fieldId' => 'employee_import'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'import-employee-form','class' => 'mr-3']); ?><?php echo app('translator')->get('app.uploadNext'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '#import-employee-form', function () {
            const url = "<?php echo e(route('employees.import.store')); ?>";
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/employees/ajax/import.blade.php ENDPATH**/ ?>