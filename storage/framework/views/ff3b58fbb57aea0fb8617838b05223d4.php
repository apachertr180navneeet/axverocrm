...
<?php $component->withAttributes(['id' => 'save-notice-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-bottom-grey">
                    <?php echo app('translator')->get('app.noteDetails'); ?></h4>
...
<?php $component->withAttributes([]); ?>
                            <option <?php if($stickyNote->colour == 'red'): ?> selected <?php endif; ?> data-content="<i class='fa fa-circle mr-2 text-red'></i>" value="red">
                            </option>
                            <option <?php if($stickyNote->colour == 'green'): ?> selected <?php endif; ?> data-content="<i class='fa fa-circle mr-2 text-dark-green'></i>"
                                value="green">
                            </option>
                            <option <?php if($stickyNote->colour == 'blue'): ?> selected <?php endif; ?> data-content="<i class='fa fa-circle mr-2 text-blue'></i>"
                                value="blue">
                            </option>
                            <option <?php if($stickyNote->colour == 'yellow'): ?> selected <?php endif; ?> data-content="<i class='fa fa-circle mr-2 text-yellow'></i>"
                                value="yellow">
                            </option>
                            <option <?php if($stickyNote->colour == 'purple'): ?> selected <?php endif; ?> data-content="<i class='fa fa-circle mr-2 text-dark-grey'></i>"
                                value="purple">
                            </option>
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('app.note'),'fieldName' => 'notetext','fieldId' => 'notetext','fieldValue' => $stickyNote->note_text] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-notice').click(function() {
            const url = "<?php echo e(route('sticky-notes.update', $stickyNote->id)); ?>";
...
<?php /**PATH /home/u536896586/domains/kactto.space/public_html/resources/views/sticky-notes/ajax/edit.blade.php ENDPATH**/ ?>