...
<?php endif; ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <h5 class="f-w-500 f-15 d-flex justify-content-between"><?php echo e(__('app.date').' - '.\Carbon\Carbon::parse($date)->translatedFormat(company()->date_format)); ?> <span class="badge badge-info f-14" style="background-color: <?php echo e($attendanceSettings->color); ?>"><?php echo e($attendanceSettings->shift_name); ?></span></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.attendance.clock_in'),'fieldPlaceholder' => __('placeholders.hours'),'fieldName' => 'clock_in_time','fieldId' => 'clock-in-time','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.attendance.clock_in_ip'),'fieldPlaceholder' => __('placeholders.hours'),'fieldName' => 'clock_in_ip','fieldId' => 'clock-in-ip','fieldValue' => request()->ip()] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Forms\ToggleSwitch::resolve(['fieldLabel' => __('modules.attendance.late'),'fieldName' => 'late','fieldId' => 'lateday'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="bootstrap-timepicker timepicker">
                            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.attendance.clock_out'),'fieldPlaceholder' => __('placeholders.hours'),'fieldName' => 'clock_out_time','fieldId' => 'clock-out'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.attendance.clock_out_ip'),'fieldPlaceholder' => __('placeholders.hours'),'fieldName' => 'clock_out_ip','fieldId' => 'clock_out_ip','fieldValue' => request()->ip()] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <?php if (isset($component)) { $__componentOriginal32ac71f8f6fe4764d54a65ca726f9ffc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal32ac71f8f6fe4764d54a65ca726f9ffc = $attributes; } ?>
<?php $component = App\View\Components\Forms\ToggleSwitch::resolve(['fieldLabel' => __('modules.attendance.halfDay'),'fieldName' => 'halfday','fieldId' => 'halfday'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.toggle-switch'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\ToggleSwitch::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($locations->id); ?>">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <option <?php if($attendance->work_from_type == 'home'): ?> selected <?php endif; ?> value="home"><?php echo app('translator')->get('modules.attendance.home'); ?></option>
                        <option <?php if($attendance->work_from_type == 'other'): ?> selected <?php endif; ?> value="other"><?php echo app('translator')->get('modules.attendance.other'); ?></option>
                        <option <?php if($attendance->work_from_type == 'office'): ?> selected <?php endif; ?> value="office"><?php echo app('translator')->get('modules.attendance.office'); ?></option>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal67cd5dc9866c6185ad92d933c387fa86)): ?>
<?php $attributes = $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86; ?>
...
<?php endif; ?>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6"  id="otherPlace" <?php if($attendance->work_from_type != 'other'): ?> style="display:none" <?php endif; ?> >
                        <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'working_from','fieldLabel' => __('modules.attendance.otherPlace'),'fieldName' => 'working_from','fieldRequired' => 'true','fieldValue' => $attendance->working_from] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                ...
                <input type="hidden" name="user_id" id="user_id" value="<?php echo e($attendanceUser->id); ?>">
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#save-attendance').click(function () {
            ...
            var url = "<?php echo e(route('attendances.store')); ?>";
            $.easyAjax({
                url: url,
                type: "POST",
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/attendances/ajax/add_user_attendance.blade.php ENDPATH**/ ?>