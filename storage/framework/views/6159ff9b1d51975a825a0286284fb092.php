    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center mt-3">
                <?php if($addNoticePermission == 'all' || $addNoticePermission == 'added'): ?>
...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('notices.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 openRightModal float-left']); ?>
                        <?php echo app('translator')->get('modules.notices.addNotice'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        const applyQuickAction = () => {
            ...
            var url = "<?php echo e(route('notices.apply_quick_action')); ?>?row_ids=" + rowdIds;
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('notices.destroy', ':id')); ?>";
        ...
        $('body').on('click', '.noticeView', function() {
            ...
            var url = "<?php echo e(route('notices.show', ':id')); ?>";
            url = url.replace(':id', id);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u566596326/domains/hreomshopping.in/public_html/resources/views/notices/index.blade.php ENDPATH**/ ?>