                            ...
                            <select class="form-control select-picker" name="leave_type_id" id="leave_type_id"
                                ...
                                <?php if(isset($leaveTypes)): ?>
                                    <?php $__currentLoopData = $leaveTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($leaveType->deleted_at == null): ?>
                                            <option value="<?php echo e($leaveType->id); ?>"><?php echo e($leaveType->type_name); ?> (<?php echo e($leaveType->no_of_leaves); ?>)
                                            </option>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                ...
                                <?php if(isset($leaveQuotas)): ?>
                                    <?php $__currentLoopData = $leaveQuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveQuota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($leaveQuota->leaveType && $leaveQuota->leaveType->leaveTypeCondition($leaveQuota->leaveType, $defaultAssign)
                                            && $leaveQuota->leaveType->deleted_at == null
                                        ): ?>
                                            <option value="<?php echo e($leaveQuota->leaveType->id); ?>"><?php echo e($leaveQuota->leaveType->type_name); ?> (<?php echo e($leaveQuota->leaves_remaining); ?>)</option>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.date'),'fieldName' => 'leave_date','fieldId' => 'single_date','fieldPlaceholder' => __('app.date'),'fieldValue' => now(company()->timezone)->translatedFormat(company()->date_format)] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\FileMultiple::resolve(['fieldLabel' => __('app.menu.addFile'),'fieldName' => 'file','popover' => __('messages.leaveFileMessage'),'fieldId' => 'leave-file-upload-dropzone'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 'attendanceMarked') {
                            ...
                            Swal.fire({
                                ...
                                text: "<?php echo app('translator')->get('messages.attendanceIsMarked'); ?>",
                                icon: 'warning',
                                showCancelButton: true,
                                focusConfirm: false,
                                confirmButtonText: "<?php echo app('translator')->get('app.apply'); ?>",
...
<?php /**PATH /home/u972418887/domains/kactto.com/public_html/crmhr/resources/views/leaves/ajax/create.blade.php ENDPATH**/ ?>