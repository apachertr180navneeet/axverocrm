...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addCustomLink']); ?>
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.customLinkSettings.addNewCustomLink'); ?></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.customLinkSettings.linkTitle'),'fieldPlaceholder' => __('placeholders.linkTitle'),'fieldName' => 'link_title','fieldId' => 'link_title','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div class=" col-md-6">
                <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.customLinkSettings.url'),'fieldPlaceholder' => __('placeholders.url'),'fieldName' => 'url','fieldId' => 'url','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'can_be_viewed_by','fieldLabel' => __('modules.customLinkSettings.canBeViewedBy'),'fieldName' => 'can_be_viewed_by[]','fieldRequired' => 'true','search' => 'true','multiple' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
$(".select-picker").selectpicker();
    ...
    // Save form data
        $('#save-form').click(function () {
            $.easyAjax({
                url: "<?php echo e(route('custom-link-settings.store')); ?>",
...
<?php /**PATH /home/u566596326/domains/hreomshopping.in/public_html/resources/views/custom-link-settings/create.blade.php ENDPATH**/ ?>