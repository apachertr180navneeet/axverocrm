...
use App\Http\Controllers\EmployeeTaskReportController;
use App\Http\Controllers\TrainingAttendanceController;
use App\Http\Controllers\OtpController;
use App\Http\Controllers\JoiningKitController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    // view daily report
    Route::get('daily-report', [DashboardController::class, 'dailyReport'])->name('dailyreport');
    Route::post('daily-report', [DashboardController::class, 'storeDailyReport'])->name('daily-report.store');
    Route::get('daily-report/list', [DashboardController::class, 'dailyReportList'])->name('daily-report.list');
    Route::get('daily-report/list/{id}', [DashboardController::class, 'dailyReportList']) ->name('daily-report.view');
    Route::get('daily-report/{id}/pdf',[DashboardController::class, 'dailyReportPdf'])->name('daily-report.pdf');
    
    Route::get('hr-executive-report', [DashboardController::class, 'executiveReport'])->name('hr.executive.report');
    Route::post('hr-executive-report-store', [DashboardController::class, 'storeExecutiveReport'])->name('hr.executive.report.store');
    Route::get('hr-executive-report-list/{id?}', [DashboardController::class, 'executiveReportList'])->name('hr.executive.report.list');
    Route::get('hr-executive-report-pdf/{id}', [DashboardController::class, 'executiveReportPdf']) ->name('hr.executive.report.pdf');   
    
     // Sales executive 
    Route::get('sales-executive',[DashboardController::class,'salesExecutive'])->name('sales-executive');
    Route::post('sales-executive',[DashboardController::class,'storeSalesExecutive'])->name('sales-executive.store');
    // List page
    Route::get('sales-executive/list',[DashboardController::class, 'salesExecutiveList'])->name('sales-executive.list');
    // PDF download
    Route::get('sales-executive/pdf/{id}',[DashboardController::class,'downloadSalesExecutivePdf'])->name('sales-executive.pdf');
    
    // Agent & RETAINER form
 
      Route::get('agent-retainer', [DashboardController::class,'listAgentRetainer'])->name('agent_retainer.list');
      Route::get('agent-retainer/create', [DashboardController::class,'agentRetainer'])->name('agent_retainer.create.auth');
    Route::post('agent-retainer/store', [DashboardController::class,'storeAgentRetainer'])->name('agent_retainer.storedata');
    ...
    //     Route::post('joiningkit', [JoiningKitController::class,'store'])->name('joiningkit.store');
    //     Route::get('joiningkit-list', [JoiningKitController::class,'index'])->name('joiningkit.list');
    //     Route::get('joiningkit-pdf/{id}', [JoiningKitController::class,'downloadPdf'])->name('joiningkit.pdf');
    ...
    //     Route::post('/otp/verify', [OtpController::class, 'verify'])->name('otp.verify');
            ...
            // ── Purana store route comment kar do ──
            // Route::post('joiningkit', [JoiningKitController::class,'store'])->name('joiningkit.store');

        // ── Naye 4 step routes ──
        Route::post('joiningkit/step1', [JoiningKitController::class, 'storeStep1'])->name('joiningkit.step1');
        Route::post('joiningkit/step2', [JoiningKitController::class, 'storeStep2'])->name('joiningkit.step2');
        Route::post('joiningkit/step3', [JoiningKitController::class, 'storeStep3'])->name('joiningkit.step3');
        Route::post('joiningkit/step4', [JoiningKitController::class, 'storeStep4'])->name('joiningkit.step4');
    ...
    // Offer Letter 
        Route::get('generate',[OfferLetterController::class,'generate'])->name('generate');
         Route::get('offer-letter/list',[OfferLetterController::class,'index'])->name('letter.list');
        ...
        // Refference form
        Route::get('refference-create',[RefferenceController::class,'create'])->name('refference.create');
        Route::post('refference-store',[RefferenceController::class,'store'])->name('refference.store');
        Route::get('refference-list',  [RefferenceController::class, 'list'])->name('refference.list');
        Route::get('refference-pdf/{id}', [RefferenceController::class, 'pdf'])->name('refference.pdf');
    ...
    Route::get('employee-report/create', [EmployeeReportController::class, 'create'])->name('employee.report.create');
    Route::post('employee-report/store', [EmployeeReportController::class, 'store'])->name('employee.report.store');
    Route::get('employee/my-reports', [EmployeeReportController::class, 'myReports'])->name('employee.reports.my');
    Route::get('employee/assigned-reports', [EmployeeReportController::class, 'assignedReports'])->name('employee.reports.assigned');
    Route::get('employee-reports/{user}', [EmployeeReportController::class, 'employeeReports'])->name('employee.report.employee');
    Route::get('employee-reports/{user}/assigned-employees',[EmployeeReportController::class, 'assignedEmployees'])->name('employee.report.assigned');
    Route::get('employee/report/details/{report}', [EmployeeReportController::class, 'show'])->name('employee.report.details');
    
    
    Route::post('employees/update-letter-status', [EmployeeController::class, 'updateLetterStatus'])->name('employees.update_letter_status');
    Route::post('employees/update-premium-status', [EmployeeController::class, 'updatePremiumStatus'])->name('employees.update_premium_status');
    ...
    Route::post('/training-attendance/store', [TrainingAttendanceController::class, 'store'])->name('training.attendance.store');

    //rabbani
    Route::get('/employee-task-report', [EmployeeTaskReportController::class, 'index'])->name('employee_task.task.index');
    Route::get('employee-task-report/create', [EmployeeTaskReportController::class, 'create'])->name('employee_task.report.create');
    Route::post('employee-task-report/store', [EmployeeTaskReportController::class, 'store'])->name('employee_task.report.store');
    Route::get('employee-task/my-reports', [EmployeeTaskReportController::class, 'myReports'])->name('employee_task.reports.my');
    Route::get('employee-task/assigned-task', [EmployeeTaskReportController::class, 'assignedReports'])->name('employee_task.task.reports.assigned');
    Route::get('employee-task/assigned-task/task', [EmployeeTaskReportController::class, 'assignedTask'])->name('employee_task.task.assigned');
    Route::get('employee-task/assigned-task/details/{report}', [EmployeeTaskReportController::class, 'show'])->name('employee_task.task.reports.details');
    Route::get('/employee-task/reports/{user}',[EmployeeTaskReportController::class, 'userReports'])->name('employee_task.reports.user');
Route::get(
    'employee-task/assigned-by-manager/{employee}',
    [EmployeeTaskReportController::class, 'assignedByManager']
)->name('employee_task.assigned.by.manager');
    ...
    Route::get('/retaner/{id}/pdf', [DashboardController::class, 'downloadRetanerPdf'])->name('retaner.pdf');
    ...
    Route::get('/export/payu/excel', [HiringController::class, 'exportPayuExcel'])->name('export.payu.excel');
    Route::get('/export/payu/pdf', [HiringController::class, 'exportPayuPdf'])->name('export.payu.pdf');
