        ...
        <form method="POST" action="{{ route('hr.executive.report.store') }}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 mb-3">
                ...
                <input type="email" value="{{ $user->email }}"  name="portal_email" class="form-control" required readonly>
            </div>
        
            <div class="col-md-6 col-12 mb-3">
                <label>Your Name <span class="text-danger">(Required)</span></label>
                <input type="text" value="{{ $user->name }}"  name="name" class="form-control" required readonly>
            </div>
