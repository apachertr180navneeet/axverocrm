...
<div class="card shadow-sm border-0" style="border-radius:12px; overflow:hidden;">
    ...
    <div class="card-body p-4">
        ...
        <form method="POST" action="{{ route('refference.store') }}" id="referenceForm" novalidate>
        @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-2">
                        ...
                        <select name="candidate_gender[]" class="form-control candidate-gender-select">
                            ...
                            <option value="Male"   {{ old('candidate_gender.0') == 'Male'   ? 'selected' : '' }}>Male</option>
                            <option value="Female" {{ old('candidate_gender.0') == 'Female' ? 'selected' : '' }}>Female</option>
                            <option value="Other"  {{ old('candidate_gender.0') == 'Other'  ? 'selected' : '' }}>Other</option>
                        </select>
