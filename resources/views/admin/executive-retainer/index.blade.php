...
<div class="content-wrapper">
    ...
    <x-cards.data padding="false" otherClasses="pt-0">
                ...
                <tr>
                    ...
                    <td>
                        @if($app->payment_status == 'success')
                            <span class="badge badge-success"><i class="fa fa-check-circle mr-1"></i>@lang('app.success')</span>
                        @elseif($app->payment_status == 'pending')
                            <span class="badge badge-warning"><i class="fa fa-clock mr-1"></i>@lang('app.pending')</span>
                        @else
                            <span class="badge badge-danger"><i class="fa fa-times-circle mr-1"></i>@lang('app.failed')</span>
                        @endif
                    </td>
                </tr>
            @empty
