...
<x-form :method="$application ? 'PUT' : 'POST'"
  ...
  <div class="add-client bg-white rounded">
            ...
            @foreach($hired as $index => $exec)
              <div class="row mb-2 executive-row align-items-end">
                <div class="col-md-4 mb-2">
                  ...
                  <select name="hired_executives[{{ $index }}][name]" class="form-control height-35 f-14 executive-name-select"
                    data-index="{{ $index }}">
            ...
            @foreach($retainers as $index => $ret)
              <div class="row mb-2 retainer-row align-items-end">
                <div class="col-md-4 mb-2">
                  ...
                  <select name="hired_retainers[{{ $index }}][name]" class="form-control height-35 f-14 retainer-name-select"
                    data-index="{{ $index }}">
    ...
    <div class="row p-20" id="retainerSection"
