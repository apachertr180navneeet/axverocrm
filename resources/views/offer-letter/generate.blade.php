            ...
            <div class="row form-row-gap">
                ...
                <div class="col-md-6 col-12">
                    ...
                    <select name="designation" class="form-control">
                        ...
                        @foreach(['Sales Manager','Assistant Sales Manager','Agent Relationship Manager','HR Manager','HR Executive','IT Executive','Sales Executive','IT Sales Manager','IT Manager','Social Media Manager','Trainer', 'Agent Manager'] as $d)
