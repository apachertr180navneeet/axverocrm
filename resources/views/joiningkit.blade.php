...
<div class="main-card" id="mainCard">
    ...
    {{-- No form action needed — AJAX handles all submissions --}}
    ...
    <div id="step2" style="display:none;">
        ...
        <div class="d-flex justify-content-between">
            {{-- Step 2 ka Previous button — step1 save hone ke baad yeh hide ho jaayega JS se --}}
    ...
    <div id="step3" style="display:none;">
        ...
        <div class="section-line"></div>
        <div class="d-flex justify-content-between">
            {{-- Step 3 ka Previous button — step2 save hone ke baad yeh hide ho jaayega --}}
    ...
    <div id="step4" style="display:none;">
        ...
        <div class="section-line"></div>
        <div class="d-flex justify-content-between">
            {{-- Step 4 ka Previous button — step3 save hone ke baad yeh hide ho jaayega --}}
...
// Step ke AJAX routes
var stepRoutes = {
    1: '{{ route("joiningkit.step1") }}',
    2: '{{ route("joiningkit.step2") }}',
    3: '{{ route("joiningkit.step3") }}',
    4: '{{ route("joiningkit.step4") }}',
};
