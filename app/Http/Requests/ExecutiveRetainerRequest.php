...
class ExecutiveRetainerRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'hired_executives.*.name' => 'nullable|string|max:255|required_with:hired_executives.*.mobile,hired_executives.*.joining_date',
            'hired_executives.*.mobile' => 'nullable|string|max:20|required_with:hired_executives.*.name,hired_executives.*.joining_date',
            'hired_executives.*.joining_date' => 'nullable|date|required_with:hired_executives.*.name,hired_executives.*.mobile',
            'hired_retainers' => 'nullable|array|max:4',
            'hired_retainers.*.name' => 'nullable|string|max:255|required_with:hired_retainers.*.mobile,hired_retainers.*.joining_date',
            'hired_retainers.*.mobile' => 'nullable|string|max:20|required_with:hired_retainers.*.name,hired_retainers.*.joining_date',
            'hired_retainers.*.joining_date' => 'nullable|date|required_with:hired_retainers.*.name,hired_retainers.*.mobile',
